...
goog.provide('Blockly.JScript.variables');

goog.require('Blockly.JScript');


Blockly.JScript['variables_get'] = function(block) {
  // Variable getter.
  var code = Blockly.JScript.variableDB_.getName(block.getFieldValue('VAR'),
      Blockly.Variables.NAME_TYPE);
  return [code, Blockly.JScript.ORDER_ATOMIC];
};

Blockly.JScript['variables_set'] = function(block) {
  // Variable setter.
