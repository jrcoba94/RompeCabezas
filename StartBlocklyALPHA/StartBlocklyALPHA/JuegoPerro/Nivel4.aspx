<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Master.Master" AutoEventWireup="true" CodeBehind="Nivel4.aspx.cs" Inherits="StartBlocklyALPHA.JuegoPerro.Nivel4" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <html>
  <script src="Juego1/js1/jquery-2.1.4.min.js" type="text/javascript"></script>
  <script src="Juego1/boostrap/bootstrap.min.js"></script>
  <head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width">      
  <title>Blockly</title>
  
  <link rel="stylesheet" href="Juego1/css/header.css">
<!--<link rel="stylesheet" href="css/main.css">-->
<link rel="stylesheet" href="Juego1/css/style.css">
<!--<link rel="stylesheet" href="css/modalPlugin.css">-->
<link rel="stylesheet" href="Juego1/boostrap/bootstrap.min.css">

<link rel="stylesheet" href="Juego1/js1/highlight/railscasts.css">
...
<div id="completedModal" class="modal fade">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a href="Nivel5.aspx" class="page-scroll btn btn-primary">Siguiente Nivel</a>
...
<%--        
      ...
      <script src="Juego1/level_4.js"></script>
