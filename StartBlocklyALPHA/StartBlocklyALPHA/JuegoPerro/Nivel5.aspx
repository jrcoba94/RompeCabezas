<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Master.Master" AutoEventWireup="true" CodeBehind="Nivel5.aspx.cs" Inherits="StartBlocklyALPHA.JuegoPerro.Nivel5" %>
...
<div id="completedModal" class="modal fade">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
 <%--       <a href="index2.aspx" class="page-scroll btn btn-primary">Siguiente Nivel</a>--%>
...
<%--        
      ...
      <script src="Juego1/level_5.js"></script>
